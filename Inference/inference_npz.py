...
class Human_Gaze_Predictor:
    ...
    def predict_and_save(self, inputs, frame_ids):
        ...
        np.savez_compressed(f"./{self.game_name}/test_with_frames.npz", heatmap=self.preds[:,:,:,0], frame_ids=frame_ids)
        print("Done. Output is:")
        print(f" {self.game_name}/test_with_frames.npz")
...
name = 'ms_pacman'
gaze_model = './happy-plasma-5.hdf5'

...
class TrainingLogger(K.callbacks.Callback):
    def on_epoch_end(self, epoch, logs=None):
        ...
        print(f"Epoch {epoch + 1}: loss = {loss:.4f}, val_loss = {val_loss:.4f}, "
              ...
              f"Duration Loss = {duration_loss_value:.4f}, val_Duration Loss = {val_duration_loss_value:.4f}")
...
def main():
    ...
    # train_opt_file = './ms_pacman/496_RZ_3560871_Jul-19-13-28-35_opt.tar.bz2'
    # train_sal_file = './ms_pacman/496_RZ_3560871_Jul-19-13-28-35_sal.tar.bz2'
    ...
    model.compile(loss=combined_loss(gaze_weight), optimizer=opt, metrics=['accuracy', iou_metric, duration_loss])
    print("Compiled")
   ...
   # Initialize callbacks
    ...
    test_loss, test_acc, test_iou, test_dur = model.evaluate(test_tf_dataset, steps=test_steps, verbose=2)
